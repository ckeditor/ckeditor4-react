...
**This branch is used only for developing `major` versions and thus might be out-of-date. For latest code see `master` branch and for latest stable version see `stable` branch and version tags.**
