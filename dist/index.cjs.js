...
var ckeditor4IntegrationsCommon = require('ckeditor4-integrations-common');
...
var defEditorUrl = 'https://cdn.ckeditor.com/4.23.0-lts/standard-all/ckeditor.js';
var defConfig = {};
...
var propTypes = __assign({
    ...
    editorUrl: PropTypes__namespace.string,
    initData: PropTypes__namespace.node,
    name: PropTypes__namespace.string,
    readOnly: PropTypes__namespace.bool,
    style: PropTypes__namespace.object,
    type: PropTypes__namespace.oneOf(['classic', 'inline']) }, defaultEvents.reduce(function (acc, key) {
    var _a;
