 ...
 */
declare function useCKEditor<EditorEvent extends string>({ config, debug, dispatchEvent, subscribeTo, editorUrl, element, type }: CKEditorHookProps<EditorEvent | CKEditorDefaultEvent>): CKEditorHookResult;
